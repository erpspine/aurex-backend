...
use App\Http\Controllers\Api\MemberServiceUsageController;
...
Route::middleware('api.token')->group(function () {
    ...
    Route::post('/members/{member}/send-expiry-reminder', [MemberController::class, 'sendExpiryReminder']);
    Route::delete('/members/{member}', [MemberController::class, 'destroy']);
    Route::get('/member-service-usages', [MemberServiceUsageController::class, 'index']);
    Route::post('/member-service-usages', [MemberServiceUsageController::class, 'store']);
    Route::post('/member-service-usages/consume', [MemberServiceUsageController::class, 'consume']);
    Route::get('/payments', [PaymentController::class, 'index']);
    Route::post('/payments', [PaymentController::class, 'store']);
    Route::get('/payments/{payment}', [PaymentController::class, 'show']);
    Route::delete('/payments/{payment}', [PaymentController::class, 'destroy']);
    Route::get('/reports', [ReportController::class, 'index']);
    Route::get('/reports/membership-reminders', [ReportController::class, 'membershipReminders']);
